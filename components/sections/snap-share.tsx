  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-6 md:px-8">
        ...
        >
          <div className="inline-flex items-center gap-1.5 rounded-full border border-[#8B3036]/40 bg-white/95 px-3 py-1.5 text-[10px] sm:text-xs tracking-[0.3em] uppercase text-[#8B3036]">
            Share Your Memories
          </div>
          <h2
            className="style-script-regular text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-[#8B3036] mt-2 sm:mt-4"
          >
            Capture & Share the Celebration
          </h2>
          <p className={`${cormorant.className} text-xs sm:text-sm md:text-base text-[#8B3036]/95 max-w-2xl mx-auto mt-2 sm:mt-4 leading-relaxed px-2`}>
          ...
          <div className="mx-auto mt-3 sm:mt-5 h-px w-20 sm:w-24 bg-[#8B3036]/60" />
        </motion.div>
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6 lg:gap-10" variants={staggerChildren} initial="initial" animate="animate">
          ...
          >
            <div className="bg-white/95 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-8 shadow-xl h-full flex flex-col justify-start border border-[#8B3036]/40">
              <div className="flex flex-col w-full">
                <h4 className={`${cormorant.className} text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-[#8B3036] mb-2 sm:mb-4 text-center`}>
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-3 md:gap-4">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/mobile-background/couple (20).webp" alt="Wedding moment 2" fill className="object-cover" style={{ imageOrientation: "from-image" }} />
                  </motion.div>
                  <motion.div
                    className="relative col-span-2 aspect-[3/2] rounded-lg sm:rounded-xl overflow-hidden shadow-md border-2 border-[#8B3036]/30 hover:border-[#8B3036]/50 transition-all"
          ...
          <motion.div className="space-y-3 sm:space-y-5 lg:space-y-6 h-full flex flex-col lg:order-2" variants={fadeInUp}>
            <div className="flex-1">
              <div className="bg-white/95 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-8 shadow-xl text-center h-full flex flex-col border border-[#8B3036]/40">
                <h4 className={`${cormorant.className} text-base sm:text-lg md:text-xl font-semibold text-[#8B3036] mb-2 sm:mb-3`}>
                  Share Our Wedding Website
                </h4>
                <p className={`${cormorant.className} text-[#8B3036] text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed px-1`}>
                ...
                <div className="mx-auto inline-flex flex-col items-center bg-white/90 backdrop-blur-sm p-2.5 sm:p-5 md:p-7 rounded-xl sm:rounded-2xl shadow-md border border-[#8B3036]/40 mb-3 sm:mb-4 flex-1 justify-center">
                  <div className="mb-2 sm:mb-3 p-1.5 sm:p-3 rounded-lg sm:rounded-xl bg-white border border-[#8B3036]/30">
                    <div className="bg-white p-1.5 sm:p-3 rounded-lg shadow-sm border border-[#8B3036]/30">
                      <QRCodeCanvas 
                        id="snapshare-qr" 
                        value={websiteUrl} 
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 sm:gap-2 mx-auto px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#657551] text-white border border-[#657551] shadow-md hover:shadow-lg hover:-translate-y-0.5 hover:bg-[#657551]/90 transition-all duration-200 text-xs sm:text-sm font-semibold"
                  >
                    <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                    <span className={`${cormorant.className} tracking-[0.15em] sm:tracking-[0.18em] uppercase font-medium`}>Download QR</span>
                  </button>
                </div>
                <p className={`${cormorant.className} text-[#8B3036] text-xs sm:text-sm mt-auto leading-relaxed`}>
                  Scan with any camera app to open the full invitation and schedule.
                </p>
              </div>
            </div>

            <div className="bg-white/95 rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-7 shadow-xl border border-[#8B3036]/40">
              <h5 className={`${cormorant.className} text-base sm:text-lg md:text-xl font-semibold text-[#8B3036] mb-2 sm:mb-3 text-center`}>
                Use Our Hashtags
              </h5>
              <p className={`${cormorant.className} text-[#8B3036] text-xs sm:text-sm text-center mb-3 sm:mb-4 leading-relaxed`}>
              ...
              <div className="space-y-2.5 sm:space-y-3 mb-3 sm:mb-4">
                {hashtags.map((hashtag, index) => (
                  <motion.div
                    key={index}
                    className="bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-[#8B3036]/40 shadow-sm hover:shadow-md transition-all duration-200"
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
                      <span className={`${cormorant.className} text-[#8B3036] font-bold text-sm sm:text-base md:text-lg break-all flex-1 text-center sm:text-left`}>
                        {hashtag}
                      </span>
                      <button
                        onClick={() => copyHashtag(hashtag, index)}
                        className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-[#657551] text-white transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105 whitespace-nowrap flex-shrink-0 ${
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 rounded-lg bg-[#657551] text-white border-2 border-[#657551] transition-all duration-200 shadow-md hover:shadow-lg hover:bg-[#657551]/90 hover:border-[#657551]/80 ${
            ...
            <div className="bg-white/95 rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-7 shadow-xl border border-[#8B3036]/40">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                <button
                  ...
                  className="group flex items-center justify-center gap-1.5 sm:gap-2 bg-white border border-[#8B3036]/40 text-[#8B3036] px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg hover:bg-[#8B3036]/10 transition-all duration-200 shadow-md hover:shadow-lg hover:border-[#8B3036]"
                >
            ...
            {driveLink && (
              <div>
                <div className="bg-white/95 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-7 shadow-xl text-center border border-[#8B3036]/40">
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-[#8B3036]/40 bg-white px-2.5 py-1 text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.32em] text-[#8B3036] mb-2 sm:mb-3">
                    Upload Your Photos & Videos
                  </div>
                  <p className={`${cormorant.className} text-[#8B3036] text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4 px-1`}>
                    Help us capture our special day! Scan the QR or use the actions below to drop your clips into our shared Drive.
                  </p>
                  <div className="mx-auto inline-flex flex-col items-center bg-white/90 backdrop-blur-sm p-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-md border border-[#8B3036]/40 mb-3 sm:mb-4">
                    <div className="mb-2 sm:mb-3 p-1.5 sm:p-3 rounded-lg sm:rounded-xl bg-white border border-[#8B3036]/30">
                      <div className="bg-white p-1.5 sm:p-3 rounded-lg shadow-sm border border-[#8B3036]/30">
                        <QRCodeCanvas id="drive-qr" value={driveLink} size={isMobile ? 130 : 200} includeMargin className="bg-white" />
                      </div>
                    </div>
                    <p className={`${cormorant.className} text-[#8B3036] text-xs sm:text-sm`}>📱 Scan with your camera app</p>
                  </div>
                  <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3">
                    <button
                      onClick={copyDriveLink}
                      className={`flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#657551] text-white border border-[#657551] shadow-sm hover:shadow-md hover:bg-[#657551]/90 text-xs sm:text-sm transition-all ${
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#657551] text-white border border-[#657551] shadow-sm hover:shadow-md hover:bg-[#657551]/90 text-xs sm:text-sm transition-all font-semibold"
                    >
                      <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                      <span className={`${cormorant.className} tracking-[0.15em] sm:tracking-[0.18em] uppercase font-medium`}>Download QR</span>
                    </button>
                    <a
                      ...
                      className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white border border-[#8B3036]/40 text-[#8B3036] shadow-sm hover:shadow-md hover:bg-[#8B3036]/10 text-xs sm:text-sm transition-all"
                    >
                      <Share2 className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                      <span className={`${cormorant.className} tracking-[0.15em] sm:tracking-[0.18em] uppercase font-medium`}>Open Drive</span>
                    </a>
                  </div>
                  <p className={`${cormorant.className} text-[#8B3036] text-xs sm:text-sm mt-2 sm:mt-3 leading-relaxed`}>or tap "Open Google Drive Folder."</p>
                </div>
              </div>
            )}
          </motion.div>
        ...
        <motion.div className="text-center mt-5 sm:mt-10" variants={fadeInUp}>
          <div className="bg-white/95 rounded-xl sm:rounded-[22px] p-4 sm:p-6 md:p-7 shadow-[0_25px_80px_rgba(0,0,0,0.15)] border border-[#8B3036]/40 max-w-3xl mx-auto backdrop-blur-xl">
            <p className={`${cormorant.className} text-[#8B3036] text-sm sm:text-base md:text-lg leading-relaxed mb-3 sm:mb-4 px-2`}>
            ...
            <div className={`${cormorant.className} flex items-center justify-center gap-2 text-[#8B3036] text-xs sm:text-sm tracking-[0.25em] sm:tracking-[0.32em] uppercase`}>
